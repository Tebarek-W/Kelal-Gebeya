      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs text-gray-500">
            &copy; 2026 Kelal Gebeya. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Telebirr_Logo.png/800px-Telebirr_Logo.png"
              alt="Telebirr"
              className="h-6 opacity-60 grayscale hover:grayscale-0 transition-all cursor-help"
              title="Telebirr Accepted"
            />
