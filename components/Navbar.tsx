      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center space-x-1 md:space-x-4">
            ...
            <Link
              href="/cart"
              className="relative p-2 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-full"
            >
            ...
            {user ? (
              ...
              <div className="hidden md:flex items-center gap-2">
                <Link
                  href="/login"
                  className="px-4 py-2 text-sm font-medium hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-md text-gray-700 dark:text-gray-200"
                >
                  Log in
                </Link>
                <Link
                  href="/register"
                  className="px-4 py-2 text-sm font-medium bg-purple-600 text-white hover:bg-purple-700 rounded-md shadow-sm transition-all hover:shadow-md"
                >
                  Sign up
                </Link>
              </div>
            ...
            <div className="space-y-1">
              {user && (
                <div className="pb-4 mb-4 border-b border-gray-100 dark:border-neutral-800">
                  <p className="text-xs text-gray-400 uppercase tracking-widest mb-2 px-3">
                    Account
                  </p>
                  <p className="px-3 text-sm font-medium text-gray-900 dark:text-white truncate mb-4">
                    {user.email}
                  </p>
                  <Link
                    href="/orders"
              ...
              <p className="text-xs text-gray-400 uppercase tracking-widest mb-2 px-3 pt-2">
                Marketplace
              </p>
